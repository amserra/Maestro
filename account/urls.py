...
urlpatterns = [
    path('login/', auth_views.LoginView.as_view(template_name='account/login.html', authentication_form=CustomAuthenticationForm, next_page='/', redirect_authenticated_user=True), name='login'),
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='account/password_reset_confirm.html', form_class=CustomPasswordResetForm), name='password_reset_confirm'),
